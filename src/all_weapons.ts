...
import HEAVY_MACE_IMPORT from "./weapons/heavy_mace.json" assert { type: "json" };
import CAVALRY_SWORD_IMPORT from "./weapons/heavy_cavalry_sword.json" assert { type: "json" };
import HIGHLAND_SWORD_IMPORT from "./weapons/highland_sword.json" assert { type: "json" };
import JAVELIN_IMPORT from "./weapons/javelin.json" assert { type: "json" };
import KATARS_IMPORT from "./weapons/katars.json" assert { type: "json" };
import KNIFE_IMPORT from "./weapons/knife.json" assert { type: "json" };
...
import ONE_HANDED_SPEAR_IMPORT from "./weapons/one_handed_spear.json" assert { type: "json" };
import PICKAXE_IMPORT from "./weapons/pickaxe.json" assert { type: "json" };
import POLEAXE_IMPORT from "./weapons/pole_axe.json" assert { type: "json" };
import POLEHAMMER_IMPORT from "./weapons/polehammer.json" assert { type: "json" };
import QUARTERSTAFF_IMPORT from "./weapons/quarterstaff.json" assert { type: "json" };
import RAPIER_IMPORT from "./weapons/rapier.json" assert { type: "json" };
import SHORT_SWORD_IMPORT from "./weapons/short_sword.json" assert { type: "json" };
import SHOVEL_IMPORT from "./weapons/shovel.json" assert { type: "json" };
import SLEDGEHAMMER_IMPORT from "./weapons/sledgehammer.json" assert { type: "json" };
import SWORD_IMPORT from "./weapons/sword.json" assert { type: "json" };
import THROWING_AXE_IMPORT from "./weapons/throwing_axe.json" assert { type: "json" };
import TWO_HANDED_HAMMER_IMPORT from "./weapons/two_handed_hammer.json" assert { type: "json" };
import SPEAR_IMPORT from "./weapons/spear.json" assert { type: "json" };
